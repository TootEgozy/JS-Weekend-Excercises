...
// maskify("Skippy") == "##ippy"
// maskify("Nananananananananananananananana Bat

maskify = (password) => password.split("").map( (char, index, password) => (index < password.length-4)? '#' : char).join("");


console.log(maskify("10987654321"));